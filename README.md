...
Open-source ESP32-CYD-based (Cheap Yellow Display) bicycle computer with a graphical display, speed tracking, trip statistics, environmental sensors, and customizable UI
